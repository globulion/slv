...
\section{Continuum model of the vibrational solvatochromism}

It is instructive to study continuum models of solvation
in terms of the vibrational frequency shifts since they 
...
\subsection{Coulombic and induction effects}
...
within Onsager model
the frequency shift (neglecting the structural distortion)
...
\begin{subequations}
 \begin{align}
   \Delta\omega_j^{\rm Coul}             &= - {\BM \mu}_j \cdot {\bf F}^{\rm Ons} \\
   \Delta\omega_j^{\rm Ind}              &= - \frac{1}{2} {\BM \mu}_j^{\rm Ind} \cdot {\bf F}^{\rm Ons} 
       - \frac{1}{2} {\BM \alpha}_j : {\bf F}^{\rm Ons} \otimes {\bf F}^{\rm Ons} 
 \end{align}
\end{subequations}
%
whereas the electric field correction term is
%
\begin{equation} 
...
Obviously, continuum model cannot take into account
...
the Onsager\hyp{}Kirkwood\hyp{}Fr{\"o}hlich (OKF) relation
...
Kirkwood correlation factor that describes the correlation between
...
solute and solvent molecules in thermal equillibrium.
...
dispersion energy approximation which states that
%
...
\section{SolX models ov vibrational solvatochromism}

As the fundamental theory of the physical origins of the vibrational
solvatochromism has been thoroughly presented, 
in this section we would like to introduce the naming convention 
...
interaction energy can be expressed as a following series
%
\begin{equation}
...
More convenient in use in the vibrational solvatochromism
...
There is no technical problem related to the differentiation of CAMM
with respect to the nuclear coordinate. However, the convergence of CAMM
...
If DMA
or CAMM are used,
SolDMA or SolCAMM models can be obtained, accordingly. 
