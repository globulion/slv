...
In the Fig.XXX we show the application of the rigid
...
limit is ineed working very well and when the reaction field\hyp{}induced 
structural distortions
are included for the NMA's dipole moment description 
we achieved quantitative agreement
with full QM results. Thus, the
...
made by these models are similar (Fig.XXX).
...
by including terms with larger $n$. In Fig.XXX we depict the
...
size of vibrational probe is smaller. But it means that the divergence sphere
...
In Fig.XXX we plot the corresponding SolChelpG-12, SolChelpG-6 and
...
In Fig.XXXa and XXXd the results of estimating Eq.~\eqref{e:approx-1} are shown.
...
\end{equation}
%
which is shown in Fig.XXXb and XXXe, certain deterioration of the SolChelpG
...
In Figs.XXX and XXX we present the SolCAMM-6 results 
...
that the data in Fig.XXXd are almost identical to those in
Fig.XXXe.

Before we close this Section, it is worth discussing 
the performance of contracted SolChelpG and
SolCAMM models. As can be seen in Figs.XXX and XXX, 
...
(Fig.XXX). One can immediately find that the overall
...
for a model NMA--(H$_2$O)$_3$ cluster shown in Fig.XXX. 
...
A, B, and C as depicted in Fig.XXX.
\label{t:ind-nonadd}}
...
frequencies were obtained for fully optimized clusters shown in Fig.XXX. The root\hyp{}mean\hyp{}square (RMS) of
...
Generally, $\Delta \omega_{6}^{\rm Disp-Approx}$ approximation
...
and translated away from NMA. In Figs.XXX, the corresponding scans are presented.
...
molecule (see the insets in Figs.XXX) and $R_d$ is the displacement along the H-bond axis.
