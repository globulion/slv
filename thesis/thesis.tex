...
\end{equation}
%
where the zeroth-order Hamiltonian $\mathscr{H}^{(0)}=\mathscr{H}_{\rm Harm}$
...
and~\eqref{e:h_anh}, the solute-solvent interaction potential
...
in the vibrational energy levels after the solute-solvent 
interaction potential is turned on. Up to the second order
of the Reighleigh-Schr{\"o}dinger perturbation theory (RSPT), 
