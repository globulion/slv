...
that we shall be using consecutively throughout this Thesis. As it was
...
Thus, we can have
SolDMA or SolCAMM models when DMA of Stone\citep{Stone.JCTC.2005} or cumulative atomic multipole
...
are the distributed solvatochromic dipoles.
...
modeling Stark tuning rates, which are approximately equal to
the solvatochromic SolMMM dipole.
...
we show the procedure of such a construction.
%
\begin{figure}[ht]
\centering
\setlength\fboxsep{0.4pt}
...
\end{figure}
%
This procedure can lead to the increase in the performance
...
the same results as uncontracted models which is shown
in Fig.~\ref{f:contr-uncontr-comparison}.
%
\begin{figure}[ht]
\centering
\setlength\fboxsep{0.4pt}
