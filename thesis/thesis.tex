...
the form from Eq.~\eqref{e:jeden} with $\tilde{\bf U}^{\rm Int}$
defined by Eqs.~\eqref{e:dwa} and \eqref{e:trzy}.
...
couplings. The first might be related to the azide symmetric
and asymmetric stretches
while the second could be considered to study the mode mixing of
ring modes in guanine that appear around 1500 cm$^{-1}$.
...
\begin{subequations}
 \begin{align}[box=\widebox]
   \overline{\Delta\omega}_j &\approx \Delta\omega_j + \omega_j^{-1} \Xi_{jk}
  \\
...
%
\begin{equation}
 \Xi_{jk} \equiv \frac{2}{M_jM_k\left(\omega_j^2 - \omega_k^2\right)} \sderivd{U}{Q_j}{Q_k}
 \sum_i \frac{g_{ijk}}{M_i\omega_i^2}  \fderiv{U}{Q_i}  
\end{equation}
%
...
of $U$. This is straightforward but tedious task and will not
be pursued here.
