...
\chapter{Vibrational solvatochromism of CN and NC modes}
...
\section{CN stretch in bulk solution}
...
\subsection{Does Stark-dipole theory describes induction effects accurately?}

It is necessary to point out the limitation of the
extended Stark theory discussed at the end of Section 2. Since
...
expression for the Stark\hyp{}dipole model in Eq. (19). 
In page~\pageref{p:solindmult} we showed that the
...
dipoles distributed over 19 different locations in MeSCN
...
solvatochromic dipole of the nitrile stretch mode (Figure S7 in
ESI). It turns out that the relative angle between the two
...
molecules (Figure~\ref{f:mescn-aj}(a)) and a large cluster taken from MD
trajectory (Figure~\ref{f:mescn-aj}(b)), we calculated the instantaneous distributed
vibrational solvatochromic dipoles (${\bf a}_j'$ in Eq. (12)) and depict
them with arrows. 
%
\begin{figure}[t!]
\centering
...
\caption{
Vibrational solvatochromic (SolEFP) induced dipole moments (gray arrows, ${\bf a}'$ in the main text) of CN stretch
mode of MeSCN interacting with water molecules. Note that the induced dipoles are delocalized even on
water molecules. (a) A cluster consisting of MeSCN and three water molecules. (b) A configuration taken
...
Therefore, it becomes clear that the Stark-dipole
...
account even the induction effect correctly.
