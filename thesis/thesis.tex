...
-\fderiv{{\bf T}_{ab}^{(2)}}{Q_i}  && \text{if $a$,$b$ belong to different molecules}
\end{matrix}\right. 
\end{equation}
%
with
%
\begin{equation}
\fderiv{{\bf T}_{ab}^{(2)}}{Q_i} = \frac{3}{r_{ab}^3} 
       \left\{ 
           \left[ 
...
\end{subequations}
%
Thus, they are easily computable and can provide the 
information on whether Stark theory based on molecular
