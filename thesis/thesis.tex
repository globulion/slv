...
effects, the first two of which
can be modelled by classical descriptors of polarity.
...
volume
(see Chapter X). Therefore, to estimate
...
\subsection{Problems with the Onsager model}
...
%
\begin{equation}
 U^{\rm dd} = \frac{\mu_0\mu_S}{r^3} \kappa
...
\begin{equation}
 \langle \Delta \omega_j^{\rm dd} \rangle_{\Omega} \approx 
-\frac{2}{3} \left[ C^{\rm EA}_j + C^{\rm MA}_j \right] \frac{\mu_0\mu_S^2}{k_BTr^6} 
...
%
\begin{equation}
\langle\Delta \omega_j^{\rm dd}\rangle \approx
4\pi \int_a^{\infty} {\rm d}r \; \overline{\Delta \omega_j^{\rm dd}}(r) r^2 \rho g(r)
\end{equation}
%
...
\begin{equation} \label{e:x123}
 \langle \Delta \omega_j^{\rm dd} \rangle \approx 
\frac{8\pi}{9a^3} \left[ C^{\rm EA}_j + C^{\rm MA}_j \right] \frac{\mu_0\mu_S^2}{k_BT} 
\end{equation}
%
Now, 
...
\end{equation}
%
By comparing Eqs.~\eqref{e:x123} and ~\eqref{e:x124}
we find that
%
\begin{equation} \label{e:x1234}
 \langle \Delta \omega_j^{\rm dd} \rangle \approx 
\frac{2\left[ C^{\rm EA}_j + C^{\rm MA}_j \right]\mu_0}{g_Ka^3}  
\left\{
\frac{\varepsilon - 1}{\varepsilon + 2} 
...
In fact, the frequency shift (including the structural distortion)
...
= \Delta\omega_j^{\rm Coul}(\varepsilon, a) + \Delta\omega_j^{\rm Ind}(\varepsilon, a)
\end{equation}
%
...
\begin{subequations}
 \begin{align}
   \Delta\omega_j^{\rm Coul}(\varepsilon, a) &= - {\BM \mu}_j \cdot {\bf F}^{\rm Ons} \\
   \Delta\omega_j^{\rm Ind}(\varepsilon, a)  &= - \frac{1}{2} {\BM \mu}_j^{\rm Ind} \cdot {\bf F}^{\rm Ons} 
       - \frac{1}{2} {\BM \alpha}_j : {\bf F}^{\rm Ons} \otimes {\bf F}^{\rm Ons} 
 \end{align}
\end{subequations}
%
